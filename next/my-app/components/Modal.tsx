...
export default function Modal({ children }: { children: React.ReactNode }) {
  ...
  return (
    ...
    >
      <div
        ref={wrapper}
        className="-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 bg-white p-6 sm:w-10/12 md:w-8/12 lg:w-2/5"
      >
        <button
          onClick={onDismiss}
          className="absolute top-0 right-2 cursor-pointer text-slate-400 hover:text-slate-300"
        >
          X
        </button>
